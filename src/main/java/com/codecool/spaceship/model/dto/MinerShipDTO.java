...
public class MinerShipDTO extends ShipDetailDTO {
    ...
    public MinerShipDTO(long id, String name, Color color, ShipType type, Mission mission, int engineLevel, int maxSpeed, int shieldLevel, int shieldEnergy, int maxShieldEnergy, int drillLevel, int drillEfficiency, int storageLevel, int maxStorageCapacity, Map<ResourceType, Integer> resources) {
