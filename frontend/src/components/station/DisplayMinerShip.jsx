...
export function DisplayMinerShip({ message, checkStorage }) {
  ...
  const [listTodDisplay, setListToDisplay] = useState(
    <div>nothingToDisplayYet</div>
  );
  ...
  function getShipName() {
    return (
      ...
      >
        ...
        ></input>
        <div className="button" onClick={() => renameShip(newShipName)}>
          Change!
        </div>
      </div>
    );
  ...
  return (
    <>
      ...
      >
        ...
        <div className="ship-type" style={{ fontSize: "15px" }}>
          miner ship
        </div>
